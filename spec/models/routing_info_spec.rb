...
RSpec.describe RoutingInfo, type: :model do
  describe '#routing_input HAPPY' do
  ...
  describe '#routing_input BAD' do
    ...
    it 'should NOT store with one origin ' \
       'with missing longitude, and a correct desination' do
      routing_info.routing_input = [
        ['22.372081'],
        ['22.284419', '114.159510']
      ]
    ...
    it 'should NOT store with one origin ' \
       'with more than two values and one desination' do
      routing_info.routing_input = [
    ...
    it 'should NOT store with a correct origin, ' \
       'and an incorrect destination with missing longitude' do
      routing_info.routing_input = [
        ['22.372081', '114.107877'],
        ['22.284419']
      ]
    ...
    it 'should NOT store with a correct origin, '\
       'and a destination with more than two values ' do
      routing_info.routing_input = [
        ['22.372081', '114.107877'],
    ...
    it 'should NOT store with a correct origin ' \
       'and a destination with wrong format' do
      routing_info.routing_input = [
        ['22.372081', '114.107877'],
        ['22.aaa', '114.159510']
      ]
